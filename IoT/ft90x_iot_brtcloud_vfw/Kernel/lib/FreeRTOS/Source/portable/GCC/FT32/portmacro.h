...
#endif
#define portIRQ_SET_MASK_ALL()                  portIRQ_SET(IRQ_MASK_ALL);portIRQ_SET(IRQ_MASK_ALL);portIRQ_SET(IRQ_MASK_ALL)
...
/*
 * kahho::
 * Use this to support nested critical sections.
 * Note that for FreeRTOS, context switch by application can take place within critical section.
 * FreeRTOS defines critical section as being not pre-emptable (by IRQ or systick for example).
 */
...
#define taskYIELD_FROM_ISR(a)                    portYIELD_FROM_ISR(a)
