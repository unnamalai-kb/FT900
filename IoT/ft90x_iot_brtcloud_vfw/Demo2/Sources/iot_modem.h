...
#define VFW_APP 1
#define UNUSED_DEMO_FUNCTIONS	1
...
#if SENSOR_DASHBOARD
#define API_GET_PERIPHERAL_DEVICES 			"get_devs"
#endif
...
#define API_RECEIVE_SENSOR_READING           "rcv_sensor_reading"
#define API_SENSORCFG_RECEIVE               "rcv_configuration"
#define API_SETTINGS                        "set_settings"
#define API_GET_SETTINGS                        "get_settings"
...
#define UART_ATCOMMANDS_COUNT              7/*15*/
...
#define DEVICE_DIGI2_FORMAT                                 "format"
...
#define TOPIC_IND_SENSOR									"\"%s%d\":[{\"value\":%d, \"class\": %d}]"
#define TOPIC_MULTI_SENSOR									"{\"%s\": [{\"value\": %d.%d, \"class\": %d,\"subclass\": {\"value\": %d.%d, \"class\": %d}}]}"
#define TOPIC_PAYLOAD										"{\"sensors\": %s}"
#define GET_IND_PAYLOAD										"\"%s%d\": [{\"class\": %d, \"enabled\": %d}]"
#define GET_DEV_PAYLOAD										"{\"value\": {%s}}"


#define TOPIC_1WIRE__                                 		"{\"sensors\": {\"1wire1\": [{\"value\": %d.%d, \"class\": %d}]}}"
#define TOPIC_TPROBE__                                 		"{\"sensors\": {\"tprobe1\": [{\"value\": %d.%d, \"class\": %d, \"subclass\": {\"value\": %d, \"class\": %d}}]}}"
#define TOPIC_ADC1__                                 		"{\"sensors\": {\"adc1\": [{\"value\": %d.%d, \"class\": %d}]}}"
#define TOPIC_SENSOR_DASHBOARD								"{\"value\": {\"adc1\": [{\"class\": %d, \"enabled\": %d}], \"1wire1\": [{\"class\": %d, \"enabled\": %d}], \"tprobe1\": [{\"class\": %d, \"enabled\": %d}]}}"
...
int  iot_modem_i2c_enable(const char* properties,uint8_t ucNumber);
void iot_modem_i2c_set_properties(const char *json,uint8_t);
int iot_modem_i2c_get_properties(const char *,char *payload, int plen);
int iot_modem_i2c_get_devices(const char *,char *payload, int plen);
uint32_t iot_modem_i2c_get_sensor_reading(DEVICE_PROPERTIES* properties,char *,int,char *,int);
...
uint32_t iot_modem_adc_get_sensor_reading(DEVICE_PROPERTIES* properties,char *,int,char *,int);
...
uint16_t iot_modem_1wire_get_sensor_reading(DEVICE_PROPERTIES* properties,char *,int,char *,int);
#endif
...
uint16_t iot_modem_tprobe_get_sensor_reading(DEVICE_PROPERTIES* properties,char *,int,char *,int);
#endif
